package com.example.generalpool.data.repository
...
import com.example.generalpool.data.models.UpdatedOrderData
...
class UpdateOrdersStatusRepositoryImpl(
    ...
    override suspend fun updateOrderStatus(
        ...
        Log.d("OrderAction", "POST body = $req") // will print the data class
    ...
    private fun mapToOrderInfo(
        ...
        OrderInfo(
            ...
            lat = 0.0,
            lng = 0.0,
            status = OrderStatus.Companion.fromId(d?.statusId),
            price = "---",
            customerPhone = null,
            details = d?.address,
            customerId = null,
